...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        restaurant = new Restaurant("New Restaurant", "Banglore", openingTime, closingTime);
        Restaurant spyRestaurant = spy(restaurant);

        when(spyRestaurant.getCurrentTime()).thenReturn(time);

        assertTrue(spyRestaurant.isRestaurantOpen());

       /* Restaurant res = Mockito.spy(restaurant);
        Mockito.when(res.getCurrentTime()).thenReturn(time);
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time()
    {
        ...
        restaurant = new Restaurant("New Restaurant", "Bangalore", openingTime, closingTime);
        Restaurant spyRestaurant = spy(restaurant);
